...
add_action('wp_ajax_nopriv_pategg_process_contact_form', 'pategg_process_contact_form');
add_action('wp_ajax_pategg_process_contact_form', 'pategg_process_contact_form');
function pategg_process_contact_form() {
	pategg_validate_nonce($_POST['nonce'], 'secret-key-form');

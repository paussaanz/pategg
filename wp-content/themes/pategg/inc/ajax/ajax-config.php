...
add_action( 'wp_enqueue_scripts', 'pategg_insert_custom_js_ajax' );
function pategg_insert_custom_js_ajax()
{
	wp_localize_script(
		'all',
		'ajax_forms',
...
add_filter( 'the_content', 'pategg_show_contact_ajax_form' );
function pategg_show_contact_ajax_form( $content )
{
	ob_start();
